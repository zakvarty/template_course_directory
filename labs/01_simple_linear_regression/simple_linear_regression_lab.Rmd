...
author: "Chirs Hallsworth and Zak Varty"
date: "13/08/2021"
output: 
...
points(x = a, y = b, pch = 16, col = 2, cex = 1.5)
```
...
__Solution 4.3:__ 
Let $\hat \beta_0$ and $\text{SE}(\hat\beta_0)$ denote the least squares estimimate of the intercept $b_0$ and its associated standard error. An approximate $100(1-\alpha)\%$ confidence interval for $b_0$ is given by: 
...
is_covering_true_value <- a > CIs_lower & a < CIs_upper
